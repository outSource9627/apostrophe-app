...
const styles = StyleSheet.create({
  ...
  corner: { position: 'absolute', width: 20, height: 20, borderColor: color.borderStrong },
  ...
  body: { paddingHorizontal: 17, paddingTop: 15, paddingBottom: 17 },
  nameRow: { flexDirection: 'row', alignItems: 'baseline', justifyContent: 'space-between', gap: space.md },
  name: { fontFamily: fontFamilyNative.display, fontSize: 19, color: color.text, flexShrink: 1 },
  city: { fontSize: 10.5, letterSpacing: 0.9, color: color.textSubtle },
  qualification: { marginTop: space.xs, fontSize: 12.5, color: color.textMuted },
  later: { marginTop: 11, fontSize: fontSize.sm, color: color.textSubtle },
})
