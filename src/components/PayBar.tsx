...
const styles = StyleSheet.create({
  ...
  row: { flexDirection: 'row', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: space['11'] },
  priceRow: { flexDirection: 'row', alignItems: 'baseline', gap: space['9'] },
  price: { fontFamily: fontFamilyNative.display, fontSize: fontSize.xl, color: color.text },
  detail: { fontSize: fontSize['12-5'], color: color.textMuted },
  aside: { fontSize: fontSize['12-5'], color: color.textSubtle },
  cta: {
    height: height['control-lg'],
