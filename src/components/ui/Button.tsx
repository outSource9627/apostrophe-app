...
type Variant = 'primary' | 'secondary' | 'outline' | 'quiet' | 'text' | 'destructive'
...
export function Button({
  ...
  const onDark = variant === 'primary' || variant === 'secondary'
  const tint = disabled
    ? color.textSubtle
    : { primary: color.textInverse, secondary: color.textInverse, outline: color.text, quiet: color.text, text: color.accent, destructive: color.danger }[variant]
