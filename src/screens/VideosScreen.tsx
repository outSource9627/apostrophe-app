...
const styles = StyleSheet.create({
  ...
  scroll: { paddingHorizontal: space['20'], paddingTop: space.sm },
  eyebrow: { fontSize: fontSize.xs, letterSpacing: trackingNative.eyebrow, color: color.textSubtle },
  headline: { marginTop: space['11'], fontFamily: fontFamilyNative.display, fontSize: fontSize['30'], color: color.text },
  lede: { marginTop: space.sm, fontSize: fontSize['13-5'], lineHeight: leadingNative.lede, color: color.textMuted },
  verified: {
    flexDirection: 'row', gap: space['13'], alignItems: 'center', backgroundColor: color.ink,
    borderRadius: radius['12'], padding: space.md, marginTop: space.xl,
  },
  verifiedThumb: {
    width: container['video-thumb-compact'], height: height['video-thumb-compact'], borderRadius: radius['7'], backgroundColor: color.inkRaised,
    alignItems: 'center', justifyContent: 'center',
  },
  verifiedTitle: { marginTop: space.sm, fontFamily: fontFamilyNative.display, fontSize: fontSize['17'], color: color.textInverse },
  verifiedMeta: { marginTop: space['2'], fontSize: fontSize['12'], color: color.textOnInkSubtle },
  row: {
    flexDirection: 'row', gap: space['13'], alignItems: 'flex-start', borderWidth: borderWidth.thin, borderColor: color.border,
    borderRadius: radius['12'], padding: space.md, marginTop: space['11'],
  },
  thumb: {
    width: container['video-thumb-compact'], height: height['video-thumb-compact'], borderRadius: radius['7'], backgroundColor: color.surfaceSunken,
    alignItems: 'center', justifyContent: 'center',
  },
  rowBody: { flex: 1 },
  pill: { alignSelf: 'flex-start', borderRadius: radius.pill, paddingHorizontal: space['9'], paddingVertical: space['3'] },
  pillText: { fontSize: fontSize['10-5'], fontWeight: fontWeight.medium },
  rowTitle: { marginTop: space.sm, fontSize: fontSize['14-5'], fontWeight: fontWeight.medium, color: color.text },
  rowMeta: { marginTop: space['2'], fontSize: fontSize['12'], color: color.textSubtle },
  reason: { marginTop: space.sm, fontSize: fontSize['12-5'], lineHeight: leadingNative.body, color: color.danger },
  ...
  emptySlot: {
    flexDirection: 'row', gap: space['13'], alignItems: 'center', borderWidth: borderWidth.thin, borderStyle: 'dashed',
    borderColor: color.borderStrong, borderRadius: radius['12'], padding: space.md, marginTop: space['11'],
  },
  plus: {
    width: container['video-thumb-compact'], height: height['video-thumb-compact'], borderRadius: radius['7'], backgroundColor: color.surface,
    borderWidth: borderWidth.thin, borderColor: color.border, alignItems: 'center', justifyContent: 'center',
  },
  slotTitle: { fontSize: fontSize['14-5'], fontWeight: fontWeight.medium, color: color.textMuted },
  toggleRow: {
  ...
  toggleText: { flex: 1 },
  toggleTitle: { fontSize: fontSize['14-5'], fontWeight: fontWeight.medium, color: color.text },
  toggleBody: { marginTop: space['3'], fontSize: fontSize['12-5'], lineHeight: leadingNative.body, color: color.textMuted },
})
