...
const styles = StyleSheet.create({
  ...
  saveExitTarget: { height: height.tap, justifyContent: 'center', paddingHorizontal: space['10'], marginRight: -space['10'] },
  saveExit: { fontSize: fontSize['14'], color: color.accent, fontWeight: fontWeight.medium },
  eyebrow: { fontSize: fontSize.xs, letterSpacing: trackingNative.eyebrow, color: color.textSubtle },
  progressWrap: { paddingHorizontal: space['20'], paddingTop: space.sm },
  segments: { flexDirection: 'row', gap: space['5'] },
  segment: { flex: 1, height: space.xs, borderRadius: radius.pill, backgroundColor: color.surfaceSunken },
  progressLabels: { flexDirection: 'row', justifyContent: 'space-between', marginTop: space['9'] },
  progressNow: { fontSize: fontSize['12'], color: color.textMuted },
  progressGate: { fontSize: fontSize['12'], color: color.textSubtle },
  scroll: { paddingHorizontal: space['20'], paddingTop: space['26'], paddingBottom: space.xl },
  headline: { fontFamily: fontFamilyNative.display, fontSize: fontSize['30'], color: color.text },
  ...
  input: {
    ...
    borderRadius: radius['10'], paddingHorizontal: space['15'], fontSize: fontSize['16'], color: color.text,
  },
  pair: { flexDirection: 'row', gap: space.md },
  pairItem: { flex: 1 },
  proof: {
    marginTop: space.lg, borderWidth: borderWidth.thin, borderColor: color.border, borderLeftWidth: borderWidth.accent,
    borderLeftColor: color.accent, borderRadius: radius['10'], padding: space['15'],
  },
  proofTitle: { fontSize: fontSize['14'], fontWeight: fontWeight.medium, color: color.text },
  proofBody: { marginTop: space.xs, fontSize: fontSize['12-5'], lineHeight: leadingNative.body, color: color.textMuted },
  choose: {
  ...
  chooseLabel: { fontSize: fontSize['14'], color: color.text },
  needed: { marginTop: space.xl, backgroundColor: color.surfaceMuted, borderRadius: radius['12'], padding: space.lg },
  neededTitle: { fontSize: fontSize['14'], fontWeight: fontWeight.medium, color: color.text },
  ...
  footer: {
    ...
    paddingHorizontal: space['20'], paddingTop: space.md,
  },
  savedRow: { flexDirection: 'row', alignItems: 'center', gap: space['7'], marginBottom: space['10'] },
  savedText: { fontSize: fontSize['12-5'], color: color.textMuted },
  cta: { height: height['control-lg'], borderRadius: radius.pill, backgroundColor: color.accent, alignItems: 'center', justifyContent: 'center' },
  ctaPressed: { backgroundColor: color.accentHover },
  ctaLabel: { color: color.textInverse, fontSize: fontSize['16'], fontWeight: fontWeight.semibold },
})
