...
const styles = StyleSheet.create({
  ...
  avatarTarget: { width: 44, height: 44, alignItems: 'center', justifyContent: 'center', marginRight: -8 },
  avatar: {
    width: 34, height: 34, borderRadius: radius.pill,
    backgroundColor: color.surfaceMuted, borderWidth: 1, borderColor: color.border,
    alignItems: 'center', justifyContent: 'center',
  },
  avatarText: { fontSize: 12, color: color.textMuted, fontWeight: fontWeight.medium },
  scroll: { paddingHorizontal: space.lg + 4, paddingTop: space.lg - 2, paddingBottom: space['2xl'] },
  ...
  cardWrap: { marginTop: space.xl - 2 },
  caption: { marginTop: space.lg - 2, fontSize: fontSize.sm, lineHeight: 20, color: color.textSubtle },
  beats: { marginTop: space.xl, borderTopWidth: 1, borderTopColor: color.border },
  beat: { flexDirection: 'row', gap: 13, paddingVertical: space.lg - 2, borderBottomWidth: 1, borderBottomColor: color.border },
  beatNumber: { fontFamily: fontFamilyNative.display, fontSize: 12.5, color: color.accent, width: 20, paddingTop: 2 },
  beatBody: { flex: 1 },
  beatTitle: { fontSize: 13.5, fontWeight: fontWeight.medium, color: color.text },
  beatText: { marginTop: 2, fontSize: 13.5, lineHeight: 20, color: color.textMuted },
  paid: { paddingHorizontal: space.lg + 4, paddingTop: space['3xl'] },
  link: { marginTop: space.xl, fontSize: fontSize.lg - 2, color: color.accent, fontWeight: fontWeight.semibold },
})
