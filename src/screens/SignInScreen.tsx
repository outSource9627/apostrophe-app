...
const styles = StyleSheet.create({
  ...
  headline: {
    ...
    fontSize: fontSize['38'], lineHeight: leadingNative.displayLg, color: color.textInverse, marginTop: space['2xl'],
  },
  ...
  lede: {
    ...
    lineHeight: leadingNative.ledeLg,
    color: color.textOnInkMuted,
  },
  sheet: {
    backgroundColor: color.surface,
    borderTopLeftRadius: radius['22'], borderTopRightRadius: radius['22'],
    paddingHorizontal: space.xl, paddingTop: space['30'],
  },
  eyebrow: { fontSize: fontSize.xs, letterSpacing: trackingNative.eyebrow, color: color.textSubtle },
  label: { marginTop: space['20'], fontSize: fontSize.sm, fontWeight: fontWeight.medium, color: color.text },
  control: {
    marginTop: space['9'], height: height['control-touch'], flexDirection: 'row', alignItems: 'center', gap: space.md,
    borderWidth: borderWidth.thin, borderColor: color.borderStrong, borderRadius: radius['10'], paddingHorizontal: space.lg,
  },
  prefix: { fontSize: fontSize['16'], color: color.textSubtle },
  divider: { width: borderWidth.thin, height: space['20'], backgroundColor: color.border },
  input: { flex: 1, fontSize: fontSize['17'], color: color.text, padding: 0 },
  sentTo: { marginTop: space.lg, fontSize: fontSize.base, color: color.textMuted },
  hiddenInput: { position: 'absolute', top: 0, left: 0, right: 0, height: height['otp-cell'], opacity: opacity.hidden, zIndex: 2 },
  cells: { flexDirection: 'row', gap: space['10'], marginTop: space.lg },
  cell: {
    flex: 1, height: height['otp-cell'], borderRadius: radius['10'], borderWidth: borderWidth.thin, borderColor: color.border,
    backgroundColor: color.surface, alignItems: 'center', justifyContent: 'center',
  },
  cellActive: { borderColor: color.text },
  cellText: { fontFamily: fontFamilyNative.display, fontSize: fontSize['30'], color: color.text },
  error: { marginTop: space.md, fontSize: fontSize.sm, color: color.danger },
  cta: {
    marginTop: space['14'], height: height['control-touch'], borderRadius: radius.pill, backgroundColor: color.accent,
  ...
  footerTarget: { marginTop: space.lg, height: height['tap-lg'], alignItems: 'center', justifyContent: 'center' },
  backRow: { flexDirection: 'row', alignItems: 'center', gap: space['6'] },
  footer: { fontSize: fontSize['14'], color: color.textMuted },
